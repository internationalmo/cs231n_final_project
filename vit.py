...
def train_model(args):
    selected_model = "google/vit-base-patch16-224-in21k"
    ...
    config = AutoConfig.from_pretrained(finetune_model)
...
#        python3 vit.py --to_normalize=1 --horizontal_p=0.5 --vertical_p=0  --model_output_dir="./dummy_results" --pretrain_model_dir="./dummy_results/pretrain/vit" --confusion_matrix_path="./heatmaps/heatmap_v2.png" --num_examples=2000 --pretrain_epochs=2 --train_epochs=2
#   Example command to run without pretraining:
#        python3 vit.py --to_normalize=1 --horizontal_p=0.5 --vertical_p=0  --model_output_dir="./dummy_results" --confusion_matrix_path="./heatmaps/heatmap_v2.png" --num_examples=2000 --pretrain_epochs=2 --train_epochs=2
